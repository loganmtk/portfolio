...
import phpImage from "../../images/techs/new-php-logo.png";
import materializeImage from "../../images/techs/materialize.png";
import javascriptImage from "../../images/techs/javascript-39410.png";
import AlamanoProject from "../../images/projects/Alamano.jpg";
...
export const projectsPortfolio = [
  ...
  },
  {
    ...
    description:
        "Aplicación creada con React JS y Semantic UI para hacer una lista de tareas donde puedes agregarla o quitarla..",
    repository: "https://github.com/loganmtk",
    website: "#!",
  },
  {
    title: "Alamano Inventario",
    image: AlamanoProject,
    techs: [
      { name: "PHP ", src: phpImage },
      { name: "materialize", src: materializeImage },
      { name: "js", src: javascriptImage },
    ],
    description:
        "Aplicacion creada con PHP, JavaScript y Materialize para hacer un sistema de inventario y punto de venta.",
    repository: "https://github.com/loganmtk/portfolio",
    website: "https://p1.gerardomp.com/#/form_account",
  },
  {
    title: "Marvel API",
    image: marvelProject,
